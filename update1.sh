...
addmotd() {
	...
	Chat:    \033[0m\033[mhttps://gitter.im/termux/termux/\0#!/data/data/com.termux/files/usr/bin/bash
addprofile()
{
	cat > ${PREFIX}/share/TermuxAlpine/etc/profile <<- EOM
	export CHARSET=UTF-8
...
addmotd() {
	...
	Chat:    \033[0m\033[mhttps://gitter.im/termux/termux/\033[0m\033[1;34m
		Help:    \033[0m\033[34minfo <query> \033[0m\033[mand \033[0m\033[34mman <query> \033[0m\033[1;34m
			Portal:  \033[0m\033[mhttps://wiki.ter#!/data/data/com.termux/files/usr/bin/bash
addprofile()
{
	cat > ${PREFIX}/share/TermuxAlpine/etc/profile <<- EOM
	export CHARSET=UTF-8
...
updrepos() {
	...
	cat > ${PREFIX}/share/TermuxAlpine/etc/apk/repositories <<- EOM33[0m\033[1;34m
		Help:    \033[0m\033[34minfo <query> \033[0m\033[mand \033[0m\033[34mman <query> \033[0m\033[1;34m
			Portal:  \033[0m\033[mhttps://wiki.termux.com/wiki/Community\033[0m\033[1;34m
...
updrepos() {
	cp ${PREFIX}/share/TermuxAlpine/etc/apk/repositories ${PREFIX}/share/TermuxAlpine/etc/apk/repositories.bak
	cat > ${PREFIX}/share/TermuxAlpine/etc/apk/repositories <<- EOMmux.com/wiki/Community\033[0m\033[1;34m
